...
const Home = () => {
  return (
    <div className=".container w-screen h-full bg-[#CEC1A3] lg:max-w-6xl lg:mx-auto">
      ...
      <div className="bg-gray-300 w-full flex items-center justify-center h-40 mb-15 mt-4 lg:h-60 lg:mt-8 lg:mb-8">
        <p className="text-center lg:text-xl">Video Place</p>
      </div>
      <div className="products grid grid-cols-2 gap-4 w-full justify-items-center lg:grid-cols-4 lg:gap-6 lg:max-w-5xl lg:mx-auto">
        <Link
          href={"/velvethoney"}
          className="h-62  lg:h-92 w-[70%] rounded-2xl shadow-md cursor-pointer"
        >
          {/* Image container */}
      ...
      <hr className="border-t-2 border-black my-4 mx-20 lg:max-w-4xl lg:mx-auto" />
      <div className="mt-5 flex flex-col gap-5 items-center lg:flex-row md:flex-row md:justify-around lg:justify-around lg:max-w-4xl lg:mx-auto lg:mt-8">
      ...
      <p className="font-medium text-center pb-5 pt-5 lg:text-lg">
